    ...
    .row.justify-content-center.BG01.p-4.mb-4
      ...
      .col-md-6
        ul.lista-ul--color.ms-4
          ...
          li
            <i class="fas fa-check-circle" style="color:#6ACEAE"></i>
            | Servidores de base de datos y su respectivos clientes , servidores de aplicaciones y balanceadores de carga de acuerdo con el análisis y el ambiente que se vaya a verificar.
    ...
    .row.justify-content-center
      .col-md-11
        SlyderF(columnas="col-md-4")
          .BG02.mx-2
            .row.justify-content-center.BG07.p-4
              figure.my-4
                img(src="@/assets/curso/tema3/img08.png")
              .col-auto.BGR02
                .h4.mx-4.mb-0 Openssl
            .row.justify-content-center.BG10.p-4
